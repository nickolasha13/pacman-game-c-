...
{
    private static Dictionary<string, Font> _fontCache = new();
    ...
    public static Font Font(string name) => _fontCache[name];
    public static Texture Texture(string name) => _textureCache[name];
}
